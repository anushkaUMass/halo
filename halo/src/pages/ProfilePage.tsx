...
export default function ProfilePage() {
  ...
  // this state stores the saved first name for display purposes
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setSavedFirstName(formData.firstName); // update savedFirstName only when "Save Profile" is clicked
    alert('Profile Saved!');
  };
